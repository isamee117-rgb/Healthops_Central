...
class OtFormSectionController extends Controller
{
    ...
    {
        $sections = OtFormSection::orderBy('sort_order')->orderBy('id')->get();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $maxOrder = OtFormSection::max('sort_order') ?? 0;

            $section = OtFormSection::create([
                'key'        => $key,
    ...
    {
        try {
            $section    = OtFormSection::findOrFail($id);
            $updateData = [];
