...
<div class="module-page">
    ...
    <p class="section-desc">
        ...
        <a href="<?php echo e(url('/configuration/human-resources')); ?>" style="color:var(--aqua-mint);font-weight:600">Human Resources Configuration</a>.
        The <strong>Bed</strong> dropdown shows beds created in
        <a href="<?php echo e(url('/bed-management')); ?>" style="color:var(--aqua-mint);font-weight:600">Bed Management</a>.
        Manage those there.
    </p>
...
<script src="<?php echo e(asset('js/ipd-config.js')); ?>?v=<?php echo e(filemtime(public_path('js/ipd-config.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/configuration/ipd.blade.php ENDPATH**/ ?>