        ...
        <div class="bulk-import-body">
            ...
            <div id="bulkStateIdle">
                ...
                <div class="bulk-action-row" style="margin-top:12px">
                    <a class="bulk-template-btn" id="bulkTemplateXlsx" href="<?php echo e(url('/api/pharmacy-bulk-import/template')); ?>" target="_blank">
                        <i data-lucide="download" style="width:14px;height:14px"></i>
                        Template Download (Excel)
                    </a>
                    <a class="bulk-template-btn" id="bulkTemplateCsv" href="<?php echo e(url('/api/pharmacy-bulk-import/template?format=csv')); ?>" target="_blank">
                        <i data-lucide="download" style="width:14px;height:14px"></i>
...
<script src="<?php echo e(asset('js/pharmacy-config.js')); ?>?v=<?php echo e(filemtime(public_path('js/pharmacy-config.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/configuration/pharmacy.blade.php ENDPATH**/ ?>