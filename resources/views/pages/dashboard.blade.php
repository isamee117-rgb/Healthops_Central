...
<div id="clinicalDash" class="dash-panel">
    ...
    {{-- ── Row 1: 4 stat cards + 1 chart card ─────────────────────────── --}}
    ...
    {{-- ── Row 2: Orders (progress bars) + Pending Actions + Alerts ──── --}}
    <div class="db-mid-grid">

        {{-- Orders Summary styled as treatment progress ────────────────── --}}
        <div class="db-card">
            <div class="db-card-head">
        ...
        {{-- Pending Actions styled as employee list ─────────────────────── --}}
        <div class="db-card">
            <div class="db-card-head">
                <div class="db-card-label"><i data-lucide="clipboard-check"></i> Pending Actions</div>
                <a href="{{ url('/ipd') }}" class="db-see-details"><i data-lucide="chevron-right"></i> View All</a>
            </div>
        ...
        {{-- Clinical Alerts styled as satisfaction card ──────────────────── --}}
        <div class="db-card">
            <div class="db-card-head">
    ...
    {{-- ── Row 3: Bed Mini Overview + Clinical Chart ────────────────────── --}}
    ...
    <div class="db-card db-patient-card db-fullrow">
        <div class="db-patient-head">
            ...
            <button class="db-table-btn" onclick="location.href='{{ url('/patients') }}'">
    ...
    <div class="db-card db-fullrow">
        ...
        <div class="db-qa-row">
            <a href="{{ url('/patients') }}"              class="db-qa-btn"><i data-lucide="user-plus"></i> Register Patient</a>
            <a href="{{ url('/opd') }}"                   class="db-qa-btn"><i data-lucide="stethoscope"></i> Create OPD</a>
            <a href="{{ url('/ipd') }}"                   class="db-qa-btn"><i data-lucide="bed"></i> IPD Admission</a>
            <a href="{{ url('/emergency') }}"             class="db-qa-btn"><i data-lucide="activity"></i> Emergency</a>
            <a href="{{ url('/laboratory/test-orders') }}"class="db-qa-btn"><i data-lucide="flask-conical"></i> Order Lab</a>
            <a href="{{ url('/pharmacy/dispensing') }}"   class="db-qa-btn"><i data-lucide="pill"></i> Dispense Medicine</a>
        </div>
    </div>
...
<div id="financialDash" class="dash-panel" style="display:none">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:12px">
        ...
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
            ...
            <a href="{{ url('/income-expense') }}" class="db-table-btn" style="text-decoration:none"><i data-lucide="download"></i> Export</a>
            <a href="{{ url('/billing') }}" class="db-qa-btn" style="background:#060740;color:#7FFFD4;border-color:#060740;text-decoration:none">
    ...
    <div class="fin2-stat-grid">
        ...
        {{-- OPD Revenue (maps to "Net Profit" slot) --}}
        <div class="fin2-stat-card">
            <div class="fin2-stat-top">
    ...
    <div class="fin2-tab-pane" id="finTab-revenue">
        ...
        <div class="fin2-chart-layout">
            ...
            {{-- Right: Revenue Breakdown sidebar --}}
        ...
        {{-- Department Revenue Table (Monthly Performance) --}}
        <div class="db-card" style="margin-top:16px">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
                ...
                <a href="{{ url('/income-expense') }}" class="db-see-details"><i data-lucide="chevron-right"></i> View All</a>
            </div>
            <div style="overflow-x:auto">
            ...
            {{-- Hidden original dept revenue list for JS compatibility --}}
    ...
    <div class="fin2-tab-pane" id="finTab-claims" style="display:none">
        ...
        {{-- Revenue cards (hidden here for JS compatibility) --}}
        <div style="display:none">
    ...
    <div class="fin2-tab-pane" id="finTab-actions" style="display:none">
        <div class="db-card">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:12px">
                <a href="{{ url('/billing') }}"            class="fin2-qa-tile"><i data-lucide="wallet"></i><span>Collect Payment</span></a>
                <a href="{{ url('/billing') }}"            class="fin2-qa-tile"><i data-lucide="file-text"></i><span>Generate Invoice</span></a>
                <a href="{{ url('/pharmacy/billing') }}"   class="fin2-qa-tile"><i data-lucide="pill"></i><span>Pharmacy Billing</span></a>
                <a href="{{ url('/laboratory/billing') }}" class="fin2-qa-tile"><i data-lucide="flask-conical"></i><span>Lab Billing</span></a>
                <a href="{{ url('/income-expense') }}"     class="fin2-qa-tile"><i data-lucide="bar-chart-2"></i><span>Income &amp; Expense</span></a>
                <a href="{{ url('/billing/ipd-discharge') }}" class="fin2-qa-tile"><i data-lucide="log-out"></i><span>IPD Discharge</span></a>
            </div>
        </div>
    </div>
