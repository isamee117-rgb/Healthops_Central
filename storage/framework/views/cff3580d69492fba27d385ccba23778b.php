...
<script src="<?php echo e(asset('js/laboratory-test-orders.js')); ?>?v=<?php echo e(filemtime(public_path('js/laboratory-test-orders.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/laboratory/test-orders.blade.php ENDPATH**/ ?>