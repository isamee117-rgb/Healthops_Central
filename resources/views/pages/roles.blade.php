...
<div class="module-page" data-user-role="{{ auth()->user()->role ?? 'user' }}" style="background:#F8F9FA;min-height:100vh;padding:24px">
...
@push('scripts')
<script src="{{ asset('js/roles.js') }}?v={{ filemtime(public_path('js/roles.js')) }}"></script>
@endpush
