...
use App\Models\IpdNumberSeries;
use App\Traits\HmsHelpers;
use Illuminate\Http\Request;

class IpdNumberSeriesController extends Controller
{
    use HmsHelpers;

    public function index()
    {
        $series = IpdNumberSeries::orderBy('id')->get();
    ...
    {
        $series = IpdNumberSeries::where('series_key', $seriesKey)->firstOrFail();
    ...
    private function buildPreview(IpdNumberSeries $series): string
    {
