...
'medicine_category' => [
    ['name' => 'Amoebicides'],
    ['name' => 'Anaesthetic & Adjuvant'],
    ['name' => 'Analgesics & Antipyretics'],
    ['name' => 'Anthelmintic Drugs'],
    ['name' => 'Anti Fungal Drugs'],
    ['name' => 'Anti Histamines/Anti Allergic'],
    ['name' => 'Anti Infective Drugs'],
    ['name' => 'Anti Malarial Drugs'],
    ['name' => 'Anti Viral Drugs'],
    ['name' => 'Antidotes'],
    ['name' => 'Antineoplastics/Immunosuppressants'],
    ['name' => 'Blood Formation/Coagulants'],
    ['name' => 'Cardio Vascular & Diuretic'],
    ['name' => 'Disinfectants & Antiseptics'],
    ['name' => 'Ear Nose & Throat'],
    ['name' => 'Gastrointestinal Drugs'],
    ['name' => 'Hormones/Endocrine'],
    ['name' => 'Immunological'],
    ['name' => 'Immunological/Biological'],
    ['name' => 'IV Fluids/Electrolytes'],
    ['name' => 'Miscellaneous Therapeutics'],
    ['name' => 'Psychotropics & Anticonvulsants'],
    ['name' => 'Respiratory Drugs'],
    ['name' => 'Sterile Ophthalmic'],
    ['name' => 'Topical Drug Preparations'],
