            ...
            <div style="margin-bottom:24px">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                    ...
                    <div style="grid-column:span 2">
                        ...
                        <select name="category" required style="width:100%;padding:9px 12px;border:1px solid var(--color-border);border-radius:8px;font-size:13px;background:#fff">
...
<script src="<?php echo e(asset('js/pharmacy-inventory.js')); ?>?v=<?php echo e(filemtime(public_path('js/pharmacy-inventory.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/pharmacy/inventory.blade.php ENDPATH**/ ?>