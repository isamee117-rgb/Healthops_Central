...
<div class="module-page">
    <div class="module-header">
        <div>
            <h1><i data-lucide="landmark"></i> Financials Configuration</h1>
            <p class="module-subtitle">Manage configurable dropdown lists and number series for Charges and Billing modules</p>
        </div>
    </div>

    <div class="section-label">Dropdown Lists</div>

    <div class="row g-3" id="finConfigContainer">
        <div class="col-md-6 col-xl-4">
            <div class="card h-100" data-category="charge_category">
                <div class="card-header d-flex justify-content-between align-items-center" style="background:var(--midnight-blue);color:#fff;padding:12px 16px">
                    <h6 class="mb-0" style="font-size:14px;font-weight:600"><i data-lucide="tag" style="width:16px;height:16px;margin-right:6px"></i>Charge Category</h6>
                    <span class="badge bg-light text-dark item-count">0</span>
                </div>
                <div class="card-body p-0">
                    <div class="config-add-bar">
                        <input type="text" class="form-control form-control-sm config-new-input" placeholder="Add new charge category..." style="font-size:13px">
                        <button class="btn btn-sm btn-add-item" title="Add"><i data-lucide="plus" style="width:16px;height:16px"></i></button>
                    </div>
                    <div class="config-list" style="max-height:380px;overflow-y:auto"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <p class="section-desc">Configure how system-generated IDs are formatted when a new Charge record is created.</p>

    <div class="row g-3" id="finNumberSeriesContainer">
    </div>
</div>
@endsection
...
@push('scripts')
<script src="{{ asset('js/finance-config.js') }}?v={{ filemtime(public_path('js/finance-config.js')) }}"></script>
@endpush
