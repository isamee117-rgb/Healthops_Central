...
<head>
    ...
    <style>
        @font-face {
            font-family: 'Roobert';
            src: url('{{ asset('fonts/roobert/RoobertRegular.woff2') }}') format('woff2'),
                 url('{{ asset('fonts/roobert/RoobertRegular.ttf') }}') format('truetype');
            font-weight: 400;
            font-style: normal;
            font-display: swap;
        }
        @font-face {
            font-family: 'Roobert';
            src: url('{{ asset('fonts/roobert/RoobertMedium.woff2') }}') format('woff2'),
                 url('{{ asset('fonts/roobert/RoobertMedium.ttf') }}') format('truetype');
            font-weight: 500;
            font-style: normal;
            font-display: swap;
        }
        @font-face {
            font-family: 'Roobert';
            src: url('{{ asset('fonts/roobert/RoobertSemiBold.woff2') }}') format('woff2'),
                 url('{{ asset('fonts/roobert/RoobertSemiBold.ttf') }}') format('truetype');
            font-weight: 600;
            font-style: normal;
            font-display: swap;
        }
        @font-face {
            font-family: 'Roobert';
            src: url('{{ asset('fonts/roobert/RoobertBold.woff2') }}') format('woff2'),
                 url('{{ asset('fonts/roobert/RoobertBold.ttf') }}') format('truetype');
            font-weight: 700;
            font-style: normal;
            font-display: swap;
        }
        @font-face {
            ...
            src: url('{{ asset('fonts/sfpro/SF-Pro-Text-Regular.woff2') }}') format('woff2'),
                 url('{{ asset('fonts/sfpro/SF-Pro-Text-Regular.otf') }}') format('opentype');
            font-weight: 400;
            font-style: normal;
            font-display: swap;
        }
        @font-face {
            font-family: 'SF Pro Display';
            src: url('{{ asset('fonts/sfpro/SF-Pro-Text-Medium.woff2') }}') format('woff2'),
                 url('{{ asset('fonts/sfpro/SF-Pro-Text-Medium.otf') }}') format('opentype');
            font-weight: 500;
            font-style: normal;
            font-display: swap;
        }
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-logo">
                <img src="{{ asset('images/healthops-logo.svg') }}" alt="HealthOps" class="healthops-logo-img">
            </div>
            ...
            <form method="POST" action="{{ url('/login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-input @if($errors->has('email')) is-invalid @endif" id="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" required autofocus autocomplete="email">
                    @error('email')
                ...
                <div class="form-group">
                    ...
                    <div class="password-input-wrapper">
                        <input type="password" class="form-input @if($errors->has('password')) is-invalid @endif" id="password" name="password" placeholder="Enter your password" required autocomplete="current-password">
            ...
            <div class="login-footer">
                ...
                <div class="login-footer-copyright">&copy; {{ date('Y') }} HealthOps. All rights reserved.</div>
            </div>
        </div>
    </div>
