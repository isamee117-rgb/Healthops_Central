...
<div class="module-page">
    <div class="module-header">
        <div>
            <h1><i data-lucide="users"></i> Patient Master</h1>
            <p class="module-subtitle">Complete patient database across all departments</p>
        </div>
        <div class="module-header-actions">
            <button class="btn-primary" data-require-permission="patients.create" onclick="$('#registerModal').modal('show')"><i data-lucide="user-plus"></i> Register New Patient</button>
        </div>
    </div>
    ...
    <div class="opd-toolbar">
        <div class="opd-search-wrap">
            ...
            <input type="text" class="opd-search-input" id="patientSearch" placeholder="Search by Name, MRN, CNIC...">
        </div>
        <div class="opd-toolbar-right">
            <button class="opd-tool-btn opd-tool-btn--icon" id="btnPtFilter" onclick="togglePtFilter(event)" title="Filter">
                <i data-lucide="filter"></i>
                <span class="opd-filter-badge" id="ptFilterBadge" style="display:none">0</span>
            </button>
            <div class="opd-rows-wrap">
                <button class="opd-tool-btn opd-tool-btn--icon" id="ptRowsBtn" onclick="togglePtRowsMenu(event)" title="Rows per page">
                    <i data-lucide="layout-list"></i>
                </button>
                <div class="opd-rows-menu" id="ptRowsMenu">
                    <div class="opd-rows-head font-normal">Rows per page</div>
                    <button onclick="setPtRowsPer(10)">10 rows</button>
                    <button onclick="setPtRowsPer(25)">25 rows</button>
                    <button onclick="setPtRowsPer(50)">50 rows</button>
                    <button onclick="setPtRowsPer(100)">100 rows</button>
                </div>
            </div>
            <div class="opd-col-vis-wrap">
                <button class="opd-tool-btn opd-tool-btn--icon" title="Column Visibility" onclick="togglePtColVis(event)">
                    <i data-lucide="columns-3"></i>
                </button>
                <div class="opd-col-vis-menu" id="ptColVisMenu">
                    <div class="opd-col-vis-head">
                        <span>Column Visibility</span>
                        <button class="opd-col-vis-selall" onclick="ptColVisSelectAll()">Select All</button>
                    </div>
                    <div class="opd-col-vis-list" id="ptColVisList">
                        <label><input type="checkbox" checked data-col="0"> Photo</label>
                        <label><input type="checkbox" checked data-col="1"> MR Number</label>
                        <label><input type="checkbox" checked data-col="2"> Full Name</label>
                        <label><input type="checkbox" checked data-col="3"> Age / Gender</label>
                        <label><input type="checkbox" checked data-col="4"> CNIC</label>
                        <label><input type="checkbox" checked data-col="5"> Contact</label>
                        <label><input type="checkbox" checked data-col="6"> Last Visit</label>
                        <label><input type="checkbox" checked data-col="7"> Status</label>
                        <label><input type="checkbox" checked data-col="8"> Balance</label>
                    </div>
                    <div class="opd-col-vis-foot">
                        <button class="opd-col-vis-save" onclick="applyPtColVis()">Save</button>
                    </div>
                </div>
            </div>
            <div class="opd-export-wrap">
                <button class="opd-tool-btn" onclick="togglePtExportMenu(event)" title="Export" style="padding:0 10px">
                    <i data-lucide="upload"></i>
                    <i data-lucide="chevron-down" style="width:13px;height:13px;margin-left:2px"></i>
                </button>
                <div class="opd-export-menu" id="ptExportMenu">
                    <button onclick="exportPt('csv')"><i data-lucide="file-spreadsheet"></i> CSV</button>
                    <button onclick="exportPt('print')"><i data-lucide="printer"></i> Print</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="opd-filter-pane" id="ptFilterPane" style="display:none">
        <div class="opd-filter-pane-head">
            <span style="font-size:13px;font-weight:700;color:var(--color-foreground)">Filter Patients</span>
            <button class="opd-filter-close" onclick="togglePtFilter(event)">
        ...
        <div class="opd-filter-pane-body">
            <div class="opd-filter-field">
                ...
                <div class="opd-cs-wrap" id="ptCsStatus" data-target="ptStatusFilter" data-placeholder="All Status"></div>
                <input type="hidden" id="ptStatusFilter">
            </div>
            <div class="opd-filter-field">
                <label class="opd-filter-label">Department</label>
                <div class="opd-cs-wrap" id="ptCsDept" data-target="ptDeptFilter" data-placeholder="All Departments"></div>
                <input type="hidden" id="ptDeptFilter">
            </div>
            <div class="opd-filter-field">
                <label class="opd-filter-label">Reg. Date From</label>
                <div class="opd-dp-wrap" id="ptDpDateFrom" data-target="ptDateFrom" data-placeholder="Select date"></div>
                <input type="hidden" id="ptDateFrom">
            </div>
            <div class="opd-filter-field">
                <label class="opd-filter-label">Reg. Date To</label>
                <div class="opd-dp-wrap" id="ptDpDateTo" data-target="ptDateTo" data-placeholder="Select date"></div>
                <input type="hidden" id="ptDateTo">
            </div>
        </div>
        <div class="opd-filter-pane-foot">
            <button class="opd-filter-reset" onclick="resetPtFilters()">
            ...
            <button class="opd-filter-apply" onclick="applyPtFilters()">
    ...
    <div class="data-table-wrapper">
        ...
        <div class="opd-pagination" id="ptPagination">
            <span class="opd-page-info" id="ptTableInfo">Showing 0–0 of 0 records</span>
            <div class="opd-page-btns">
                <button class="opd-page-btn" id="ptPrevPage" disabled>
                ...
                <div class="opd-page-nums" id="ptPageNums"></div>
                <button class="opd-page-btn" id="ptNextPage" disabled>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" style="color:var(--aquamint);font-weight:700;display:flex;align-items:center;gap:8px">
                    <i data-lucide="user-plus" style="width:20px;height:20px"></i> New Patient Registration
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body" style="max-height:70vh;overflow-y:auto">
                <p style="font-size:14px;color:var(--color-muted-foreground);margin-bottom:16px">Create a new master patient record. Fields marked with * are required.</p>

                <div class="form-section">
                    <div class="form-section-title">Basic Demographics</div>
                    <div class="form-grid form-grid-3">
                        <div class="form-group">
                            <label>MR Number</label>
                            <input type="text" class="form-control" value="MRN-2026-000X" disabled style="background:var(--color-muted)">
                        </div>
                        <div class="form-group">
                            <label>Full Name *</label>
                            <input type="text" class="form-control" id="regName" placeholder="First Middle Last">
                        </div>
                        <div class="form-group">
                            <label>Father/Husband Name</label>
                            <input type="text" class="form-control" id="regFatherName" placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label>CNIC / National ID *</label>
                            <input type="text" class="form-control" id="regCnic" placeholder="XXXXX-XXXXXXX-X">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="regPhone" placeholder="03XX-XXXXXXX">
                                </div>
                                <div class="form-group">
                                    <label>Current Address *</label>
                                    <textarea class="form-control" id="regAddress" rows="3" placeholder="Full address"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid form-grid-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="regAllergies" placeholder="Medicine, Food, etc.">
                                </div>
                            </div>
                            <div style="margin-top:12px">
                                <label style="font-size:13px;font-weight:500;margin-bottom:8px;display:block">Chronic Conditions</label>
                                <div style="display:flex;flex-wrap:wrap;gap:8px">
                                    <label class="charge-item" style="margin:0;cursor:pointer;padding:8px 12px">
                                        <div class="charge-left"><input type="checkbox" class="form-check-input" value="Diabetes"> <span class="charge-name">Diabetes</span></div>
                                    </label>
                                    <label class="charge-item" style="margin:0;cursor:pointer;padding:8px 12px">
                                        <div class="charge-left"><input type="checkbox" class="form-check-input" value="Hypertension"> <span class="charge-name">Hypertension</span></div>
                                    </label>
                                    <label class="charge-item" style="margin:0;cursor:pointer;padding:8px 12px">
                                        <div class="charge-left"><input type="checkbox" class="form-check-input" value="Asthma"> <span class="charge-name">Asthma</span></div>
                                    </label>
                                    <label class="charge-item" style="margin:0;cursor:pointer;padding:8px 12px">
                                        <div class="charge-left"><input type="checkbox" class="form-check-input" value="Heart Disease"> <span class="charge-name">Heart Disease</span></div>
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid form-grid-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="regEmergencyName" placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label>Relationship</label>
                            <select class="form-select" id="regRelationship">
                                <option value="">Select</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="regEmergencyPhone" placeholder="03XX-XXXXXXX">
                        </div>
                    </div>
                </div>

                <div class="form-section">
                    <div class="form-section-title">Administrative</div>
                    <div class="form-grid form-grid-3">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display:flex;gap:16px;padding-top:8px">
                                <label style="display:flex;align-items:center;gap:6px;font-size:14px;cursor:pointer">
                                    <input type="radio" name="paymentMode" value="cash" checked class="form-check-input"> Cash
                                </label>
                                <label style="display:flex;align-items:center;gap:6px;font-size:14px;cursor:pointer">
                                    <input type="radio" name="paymentMode" value="panel" class="form-check-input"> Panel/Ins
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Referred By</label>
                            <select class="form-select" id="regReferredBy">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn-primary" id="btnSavePatient">Save & Create Patient</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="profile-tabs">
                    ...
                    <button class="profile-tab-btn" data-tab="timeline">Clinical Timeline</button>
                    <button class="profile-tab-btn" data-tab="finance">Financial History</button>
                </div>
...
<script src="<?php echo e(asset('js/patients.js')); ?>?v=<?php echo e(filemtime(public_path('js/patients.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/patients.blade.php ENDPATH**/ ?>