...
class OpdFormSectionController extends Controller
{
    ...
    {
        $sections = OpdFormSection::orderBy('sort_order')->orderBy('id')->get();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $maxOrder = OpdFormSection::max('sort_order') ?? 0;

            $section = OpdFormSection::create([
                'key'        => $key,
    ...
    {
        try {
            $section = OpdFormSection::findOrFail($id);
            $updateData = [];
