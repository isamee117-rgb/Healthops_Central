...
use App\Models\FinanceNumberSeries;
use App\Models\HospitalCharge;
use Illuminate\Http\Request;

class FinanceNumberSeriesController extends Controller
{
    public function index()
    {
        $series = FinanceNumberSeries::orderBy('id')->get();
    ...
    {
        $series = FinanceNumberSeries::where('series_key', $seriesKey)->firstOrFail();
    ...
    private function buildPreview(FinanceNumberSeries $series): string
    {
