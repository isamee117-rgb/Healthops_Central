...
<div id="fb-container">
    <div id="fb-tree">
        <div class="fb-tree-header">
            ...
            <?php if(auth()->user()->hasPermission('form-builder.manage')): ?>
...
<script src="<?php echo e(asset('js/pages/form-builder.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/form-builder.blade.php ENDPATH**/ ?>