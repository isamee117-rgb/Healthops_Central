    ...
    <div class="tab-content" id="tab-registration">
        ...
        <div class="data-table-wrapper">
            ...
            <div class="opd-pagination" id="regPagination">
                ...
                {{-- hidden select keeps JS working unchanged --}}
...
@push('scripts')
<script src="{{ asset('js/opd.js') }}?v={{ filemtime(public_path('js/opd.js')) }}"></script>
@endpush
