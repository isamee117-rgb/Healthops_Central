...
<div class="module-page">
    <div class="module-header">
        <div>
            <h1><i data-lucide="wallet"></i> Income & Expense Management</h1>
            <p class="module-subtitle">Manage non-clinical financial transactions and account heads</p>
        </div>
    </div>
    ...
    <div class="module-tabs" style="margin-bottom:20px">
        <button class="module-tab active" data-tab="heads"><i data-lucide="folder-tree"></i> Account Heads</button>
        <button class="module-tab" data-tab="transactions"><i data-lucide="arrow-left-right"></i> Transactions</button>
    </div>
    ...
    <div id="tab-heads">
        <div class="opd-toolbar">
            <div class="opd-search-wrap">
                ...
                <input type="text" class="opd-search-input" id="headSearch" placeholder="Search by head name, code, type...">
            </div>
            <div class="opd-toolbar-right">
                <button class="opd-tool-btn opd-tool-btn--icon" id="btnHdFilter" onclick="toggleHdFilter(event)" title="Filter">
                    <i data-lucide="filter"></i>
                    <span class="opd-filter-badge" id="hdFilterBadge" style="display:none">0</span>
                </button>
                <div class="opd-rows-wrap">
                    <button class="opd-tool-btn opd-tool-btn--icon" id="hdRowsBtn" onclick="toggleHdRowsMenu(event)" title="Rows per page">
                        <i data-lucide="layout-list"></i>
                    </button>
                    <div class="opd-rows-menu" id="hdRowsMenu">
                        <div class="opd-rows-head">Rows per page</div>
                        <button onclick="setHdRowsPer(10)">10 rows</button>
                        <button onclick="setHdRowsPer(25)">25 rows</button>
                        <button onclick="setHdRowsPer(50)">50 rows</button>
                        <button onclick="setHdRowsPer(100)">100 rows</button>
                    </div>
                </div>
                <div class="opd-col-vis-wrap">
                    <button class="opd-tool-btn opd-tool-btn--icon" title="Column Visibility" onclick="toggleHdColVis(event)">
                        <i data-lucide="columns-3"></i>
                    </button>
                    <div class="opd-col-vis-menu" id="hdColVisMenu">
                        <div class="opd-col-vis-head">
                            <span>Column Visibility</span>
                            <button class="opd-col-vis-selall" onclick="hdColVisSelectAll()">Select All</button>
                        </div>
                        <div class="opd-col-vis-list" id="hdColVisList">
                            <label><input type="checkbox" checked data-col="0"> Head Code</label>
                            <label><input type="checkbox" checked data-col="1"> Head Name</label>
                            <label><input type="checkbox" checked data-col="2"> Category</label>
                            <label><input type="checkbox" checked data-col="3"> Head Type</label>
                            <label><input type="checkbox" checked data-col="4"> Budget Limit</label>
                            <label><input type="checkbox" checked data-col="5"> Status</label>
                        </div>
                        <div class="opd-col-vis-foot">
                            <button class="opd-col-vis-save" onclick="applyHdColVis()">Save</button>
                        </div>
                    </div>
                </div>
                <div class="opd-export-wrap">
                    <button class="opd-tool-btn" onclick="toggleHdExportMenu(event)" title="Export" style="padding:0 10px">
                        <i data-lucide="upload"></i>
                        <i data-lucide="chevron-down" style="width:13px;height:13px;margin-left:2px"></i>
                    </button>
                    <div class="opd-export-menu" id="hdExportMenu">
                        <button onclick="exportHd('csv')"><i data-lucide="file-spreadsheet"></i> CSV</button>
                        <button onclick="exportHd('print')"><i data-lucide="printer"></i> Print</button>
                    </div>
                </div>
                <button class="btn-primary" id="btnAddHead"><i data-lucide="plus-circle"></i> New Account Head</button>
            </div>
        </div>

        <div class="opd-filter-pane" id="hdFilterPane" style="display:none">
            <div class="opd-filter-pane-head">
                <span style="font-size:13px;font-weight:700;color:var(--color-foreground)">Filter Account Heads</span>
                <button class="opd-filter-close" onclick="toggleHdFilter(event)">
            ...
            <div class="opd-filter-pane-body" style="grid-template-columns:repeat(2,1fr)">
                <div class="opd-filter-field">
                    ...
                    <div class="opd-cs-wrap" id="hdCsCategory" data-target="hdCatFilter" data-placeholder="All Categories"></div>
                    <input type="hidden" id="hdCatFilter">
                </div>
                <div class="opd-filter-field">
                    <label class="opd-filter-label">Status</label>
                    <div class="opd-cs-wrap" id="hdCsStatus" data-target="hdStatusFilter" data-placeholder="All Status"></div>
                    <input type="hidden" id="hdStatusFilter">
                </div>
            </div>
            <div class="opd-filter-pane-foot">
                <button class="opd-filter-reset" onclick="resetHdFilters()">
                ...
                <button class="opd-filter-apply" onclick="applyHdFilters()">
        ...
        <div class="data-table-wrapper">
            <div style="overflow-x:auto">
                <table class="data-table" id="headsTable">
                    <thead>
                        <tr>
                            <th>Head Code</th>
                            <th>Head Name</th>
                    ...
                    <tbody id="headsTableBody">
                        <tr><td colspan="7"><div class="empty-state"><i data-lucide="folder-tree"></i><p>Loading account heads...</p></div></td></tr>
                    </tbody>
                </table>
            </div>
            <div class="opd-pagination" id="hdPagination">
                <span class="opd-page-info" id="hdTableInfo">Showing 0–0 of 0 records</span>
                <div class="opd-page-btns">
                    <button class="opd-page-btn" id="hdPrevPage" disabled>
                    ...
                    <div class="opd-page-nums" id="hdPageNums"></div>
                    <button class="opd-page-btn" id="hdNextPage" disabled>
    ...
    <div id="tab-transactions" style="display:none">
        <div class="opd-toolbar">
            <div class="opd-search-wrap">
                <svg class="opd-search-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
                <input type="text" class="opd-search-input" id="txnSearch" placeholder="Search by description, head, reference...">
            </div>
            <div class="opd-toolbar-right">
                <button class="opd-tool-btn opd-tool-btn--icon" id="btnTxFilter" onclick="toggleTxFilter(event)" title="Filter">
                    <i data-lucide="filter"></i>
                    <span class="opd-filter-badge" id="txFilterBadge" style="display:none">0</span>
                </button>
                <div class="opd-rows-wrap">
                    <button class="opd-tool-btn opd-tool-btn--icon" id="txRowsBtn" onclick="toggleTxRowsMenu(event)" title="Rows per page">
                        <i data-lucide="layout-list"></i>
                    </button>
                    <div class="opd-rows-menu" id="txRowsMenu">
                        <div class="opd-rows-head">Rows per page</div>
                        <button onclick="setTxRowsPer(10)">10 rows</button>
                        <button onclick="setTxRowsPer(25)">25 rows</button>
                        <button onclick="setTxRowsPer(50)">50 rows</button>
                        <button onclick="setTxRowsPer(100)">100 rows</button>
                    </div>
                </div>
                <div class="opd-col-vis-wrap">
                    <button class="opd-tool-btn opd-tool-btn--icon" title="Column Visibility" onclick="toggleTxColVis(event)">
                        <i data-lucide="columns-3"></i>
                    </button>
                    <div class="opd-col-vis-menu" id="txColVisMenu">
                        <div class="opd-col-vis-head">
                            <span>Column Visibility</span>
                            <button class="opd-col-vis-selall" onclick="txColVisSelectAll()">Select All</button>
                        </div>
                        <div class="opd-col-vis-list" id="txColVisList">
                            <label><input type="checkbox" checked data-col="0"> Date</label>
                            <label><input type="checkbox" checked data-col="1"> Head</label>
                            <label><input type="checkbox" checked data-col="2"> Description</label>
                            <label><input type="checkbox" checked data-col="3"> Type</label>
                            <label><input type="checkbox" checked data-col="4"> Amount</label>
                            <label><input type="checkbox" checked data-col="5"> Payment</label>
                            <label><input type="checkbox" checked data-col="6"> Status</label>
                        </div>
                        <div class="opd-col-vis-foot">
                            <button class="opd-col-vis-save" onclick="applyTxColVis()">Save</button>
                        </div>
                    </div>
                </div>
                <div class="opd-export-wrap">
                    <button class="opd-tool-btn" onclick="toggleTxExportMenu(event)" title="Export" style="padding:0 10px">
                        <i data-lucide="upload"></i>
                        <i data-lucide="chevron-down" style="width:13px;height:13px;margin-left:2px"></i>
                    </button>
                    <div class="opd-export-menu" id="txExportMenu">
                        <button onclick="exportTx('csv')"><i data-lucide="file-spreadsheet"></i> CSV</button>
                        <button onclick="exportTx('print')"><i data-lucide="printer"></i> Print</button>
                    </div>
                </div>
                <button class="btn-primary" id="btnAddTxn"><i data-lucide="plus-circle"></i> New Transaction</button>
            </div>
        </div>

        <div class="opd-filter-pane" id="txFilterPane" style="display:none">
            <div class="opd-filter-pane-head">
                <span style="font-size:13px;font-weight:700;color:var(--color-foreground)">Filter Transactions</span>
                <button class="opd-filter-close" onclick="toggleTxFilter(event)">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                </button>
            </div>
            <div class="opd-filter-pane-body" style="grid-template-columns:repeat(4,1fr)">
                <div class="opd-filter-field">
                    ...
                    <div class="opd-cs-wrap" id="txCsType" data-target="txTypeFilter" data-placeholder="All Types"></div>
                    <input type="hidden" id="txTypeFilter">
                </div>
                <div class="opd-filter-field">
                    <label class="opd-filter-label">Status</label>
                    <div class="opd-cs-wrap" id="txCsStatus" data-target="txStatusFilter" data-placeholder="All Status"></div>
                    <input type="hidden" id="txStatusFilter">
                </div>
                <div class="opd-filter-field">
                    <label class="opd-filter-label">Date From</label>
                    <div class="opd-dp-wrap" id="txDpDateFrom" data-target="txDateFrom" data-placeholder="Select date"></div>
                    <input type="hidden" id="txDateFrom">
                </div>
                <div class="opd-filter-field">
                    <label class="opd-filter-label">Date To</label>
                    <div class="opd-dp-wrap" id="txDpDateTo" data-target="txDateTo" data-placeholder="Select date"></div>
                    <input type="hidden" id="txDateTo">
                </div>
            </div>
            <div class="opd-filter-pane-foot">
                <button class="opd-filter-reset" onclick="resetTxFilters()">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-3.86"/></svg>
                    Reset
                </button>
                <button class="opd-filter-apply" onclick="applyTxFilters()">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
                    Apply Filters
                </button>
            </div>
            ...
            <div style="overflow-x:auto">
                <table class="data-table" id="txnTable">
                    ...
                    <tbody id="txnTableBody">
                        <tr><td colspan="8"><div class="empty-state"><i data-lucide="arrow-left-right"></i><p>Loading transactions...</p></div></td></tr>
                    </tbody>
                </table>
            </div>
            <div class="opd-pagination" id="txPagination">
                <span class="opd-page-info" id="txTableInfo">Showing 0–0 of 0 records</span>
                <div class="opd-page-btns">
                    <button class="opd-page-btn" id="txPrevPage" disabled>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"/></svg>
                    </button>
                    <div class="opd-page-nums" id="txPageNums"></div>
                    <button class="opd-page-btn" id="txNextPage" disabled>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
                    </button>
                </div>
            </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="headFormSheet" style="width:550px">
    <div class="offcanvas-header" style="background:var(--midnight-blue);color:#fff;padding:16px 20px">
        <h5 class="offcanvas-title" id="headFormTitle">New Account Head</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"></button>
    </div>
    <div class="offcanvas-body" id="headFormBody" style="padding:20px"></div>
    <div class="offcanvas-footer" style="display:flex;justify-content:flex-end;gap:8px;padding:12px 20px;border-top:1px solid var(--color-border)">
        ...
        <button class="btn-primary" id="btnSaveHead" disabled><i data-lucide="check"></i> Save Head</button>
    </div>
</div>

<div class="offcanvas offcanvas-end" tabindex="-1" id="txnFormSheet" style="width:600px">
    <div class="offcanvas-header" style="background:var(--midnight-blue);color:#fff;padding:16px 20px">
        <h5 class="offcanvas-title" id="txnFormTitle">New Transaction</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"></button>
    </div>
    <div class="offcanvas-body" id="txnFormBody" style="padding:20px"></div>
    <div class="offcanvas-footer" style="display:flex;justify-content:flex-end;gap:8px;padding:12px 20px;border-top:1px solid var(--color-border)">
        <button class="btn-outline" data-bs-dismiss="offcanvas"><i data-lucide="x"></i> Cancel</button>
        <button class="btn-primary" id="btnSaveTxn" disabled><i data-lucide="check"></i> Save Transaction</button>
    </div>
</div>
...
.opd-filter-pane-body{display:grid;gap:14px;padding:16px 18px}
@media(max-width:900px){.opd-filter-pane-body{grid-template-columns:repeat(2,1fr)!important}}
@media(max-width:600px){.opd-filter-pane-body{grid-template-columns:1fr!important}}
...
<script src="<?php echo e(asset('js/income-expense.js')); ?>?v=<?php echo e(filemtime(public_path('js/income-expense.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/income-expense.blade.php ENDPATH**/ ?>