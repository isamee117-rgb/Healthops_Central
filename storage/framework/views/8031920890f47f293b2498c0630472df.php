...
<script src="<?php echo e(asset('js/hr-config.js')); ?>?v=<?php echo e(filemtime(public_path('js/hr-config.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/configuration/human-resources.blade.php ENDPATH**/ ?>