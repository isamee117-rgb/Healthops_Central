...
<div class="module-page">
    ...
    <p class="section-desc">The <strong>Department</strong> dropdown in OPD visit registration uses the departments configured in <a href="<?php echo e(url('/configuration/human-resources')); ?>" style="color:var(--aqua-mint);font-weight:600">Human Resources Configuration</a>. Manage departments there.</p>
...
<script src="<?php echo e(asset('js/opd-config.js')); ?>?v=<?php echo e(filemtime(public_path('js/opd-config.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\healthops\resources\views/pages/configuration/opd.blade.php ENDPATH**/ ?>