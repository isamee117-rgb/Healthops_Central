...
<div class="module-page">
    ...
    {{-- Document Type Settings Offcanvas --}}
    <div class="offcanvas offcanvas-end" tabindex="-1" id="docTypeSheet" style="width:440px;max-width:95vw">
        ...
        <div class="offcanvas-body" style="padding:24px;overflow-y:auto">
            ...
            {{-- Format picker — only shown for doc types that support multiple formats --}}
...
{{-- Insurance Panel Add/Edit Modal --}}
...
@push('scripts')
<script src="{{ asset('js/hospital-info.js') }}?v={{ filemtime(public_path('js/hospital-info.js')) }}"></script>
@endpush
